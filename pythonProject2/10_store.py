...
print ('Лампа - ', lamps_quantity, 'шт. Общая стоимость ламп - ', lamps_cost)
...
print ('Стол - ',tables_quantity, 'шт. Общая стоимость столов - ', tables_cost)
...
print('Диван - ', sofa_quantity, 'шт. Общая стоимость диванов - ', sofa_cost)
...
print('Стул - ', chair_quantity, 'шт. Общая стоимость стульев - ', chair_cost)
