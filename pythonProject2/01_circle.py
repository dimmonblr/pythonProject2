...
area = pi * radius ** 2
print('Площадь круга составляет', round(area, 4))

# Далее, пусть есть координаты точки

point = (23, 34)
dist_point = (point[0]**2 + point[1]**2)**0.5
#print (dist_point)
print (dist_point < radius)
...
dist_point_2 = (point_2[0]**2 + point_2[1]**2)**0.5
print (dist_point_2)
print (dist_point_2 < radius)
